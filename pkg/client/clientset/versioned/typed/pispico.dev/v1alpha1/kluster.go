...
import (
	...
	pispicodevv1alpha1 "github.com/pispico/digitalocean-operator/pkg/client/applyconfiguration/pispico.dev/v1alpha1"
	scheme "github.com/pispico/digitalocean-operator/pkg/client/clientset/versioned/scheme"
...
type KlusterInterface interface {
	...
	Apply(ctx context.Context, kluster *pispicodevv1alpha1.KlusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Kluster, err error)
	ApplyStatus(ctx context.Context, kluster *pispicodevv1alpha1.KlusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Kluster, err error)
	KlusterExpansion
}
...
func newKlusters(c *PispicoV1alpha1Client, namespace string) *klusters {
	return &klusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *klusters) Apply(ctx context.Context, kluster *pispicodevv1alpha1.KlusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Kluster, err error) {
	if kluster == nil {
...
func (c *klusters) ApplyStatus(ctx context.Context, kluster *pispicodevv1alpha1.KlusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Kluster, err error) {
	if kluster == nil {
		return nil, fmt.Errorf("kluster provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
